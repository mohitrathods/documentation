...
.. admonition:: Learn more
   ...
   The section above provides instructions for creating a basic |BOM| that will allow a product to
   be manufactured in Odoo. However, it is by no means an exhaustive summary of all the options
