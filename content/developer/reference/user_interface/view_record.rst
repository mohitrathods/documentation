...
- :ref:`Cohort <reference/user_interface/view_architecture/cohort>` ->
  display and understand the way some data changes over a period of time
- :ref:`Gantt <reference/user_interface/view_architecture/gantt>` ->
  display records as a Gantt charts (for scheduling)
- :ref:`Grid <reference/user_interface/view_architecture/grid>` ->
  display computed information in numerical cells are hardly configurable
- :ref:`Map <reference/user_interface/view_architecture/map>` ->
